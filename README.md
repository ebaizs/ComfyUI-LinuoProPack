...
**问：滑块为什么是横向条状填充样式？**  
答：插件将普通滑块美化成了渐变填充条，蓝色部分代表当前数值占比，灰色为剩余区域。拖动滑块时填充比例实时变化，更直观。
<img width="1054" height="560" alt="2" src="https://github.com/user-attachments/assets/917b020c-8ba4-4e12-97a6-828a2a071906" />
**问：空 Latent 预设支持哪些尺寸？**  
